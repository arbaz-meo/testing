...
export class Contract extends ethereum.SmartContract {
  ...
  getTokenHolding(owner: Address): Array<BigInt> {
    let result = super.call(
      "getTokenHolding",
      "getTokenHolding(address):(uint256[])",
      [ethereum.Value.fromAddress(owner)]
    );
  ...
  try_getTokenHolding(owner: Address): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "getTokenHolding",
      "getTokenHolding(address):(uint256[])",
      [ethereum.Value.fromAddress(owner)]
  ...
  mintToken(baseURI: string): BigInt {
  ...
  try_mintToken(baseURI: string): ethereum.CallResult<BigInt> {
